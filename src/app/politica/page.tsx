...
export const metadata = {
  title: "Política de la Empresa | Bienes Raices RD",
  description: "Consulta la política de empresa de Bienes Raices RD. Comprometidos con la transparencia, la calidad del servicio y la satisfacción del cliente.",
};
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-gray-800 mt-20">
      ...
      <section className="space-y-6 text-sm md:text-base leading-relaxed">
        <p>
          En <strong>Bienes Raices RD</strong>, nos regimos por principios de calidad, integridad y responsabilidad. Nuestra política empresarial está diseñada para garantizar servicios de limpieza eficientes, seguros y confiables, en beneficio de nuestros clientes y del equipo humano que forma parte de nuestra empresa.
        </p>
        ...
        <p>
          En Bienes Raices RD, apostamos por prácticas sostenibles. Minimizar el impacto ambiental es parte de nuestra política mediante el uso de productos biodegradables y procesos responsables con el entorno.
        </p>
